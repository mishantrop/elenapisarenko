    ...
    return (
        <>
            <Image
              ...
              alt="Елена Писаренко"
            />
            <p className="capitalize text-xl mb-1">
                Елена Писаренко
            </p>
            <div className="mb-4 text-sm text-gray-500 dark:text-gray-400">
                художник, филантроп, миллионер
            </div>
            <div className="flex flex-row mb-4">
                ...
                <span className="ml-2">Россия, Рыбинск</span>
            </div>
            <a href="https://www.instagram.com/elena.pisarenko.754/" rel="noreferrer noopener" target="_blank" className="flex flex-row mb-4">
            ...
            <a href="https://vk.com/public109473289" rel="noreferrer noopener" target="_blank" className="flex flex-row mb-4">
