    ...
    return (
        <>
            <Image
              ...
              alt="Елена Фамилия"
            />
            <p className="capitalize text-xl mb-4">
                Елена Фамилия
            </p>
            <div className="mb-4">художник, филантроп, миллионер</div>
            ...
            <a href="https://instagram.com/TODO" rel="noreferrer noopener" target="_blank" className="flex flex-row mb-4">
            ...
            <a href="https://vk.com/TODO" rel="noreferrer noopener" target="_blank" className="flex flex-row mb-4">
