...
export default function Sidebar() {
    ...
    const status = 'Пишу картины на заказ: масло, акрил&nbsp;и&nbsp;другие&nbsp;техники'
    ...
    return (
        <div className={classnames('text-center', styles.sidebar)}>
            ...
            <div className="mb-4 text-sm text-gray-500 dark:text-gray-400" dangerouslySetInnerHTML={{ __html: status }} />
